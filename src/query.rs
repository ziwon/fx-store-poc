    ...
    unsafe fn filter_by_price(records: &[OHLCV], min_price: u32, max_price: u32) -> Vec<OHLCV> {
        ...
        for chunk in chunks {
            ...
            let prices = _mm256_set_epi32(
                chunk[7].close as i32, chunk[6].close as i32,
                chunk[5].close as i32, chunk[4].close as i32,
                chunk[3].close as i32, chunk[2].close as i32,
                chunk[1].close as i32, chunk[0].close as i32,
            );
